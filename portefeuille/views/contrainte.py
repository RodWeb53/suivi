...
def contrainte(request):
    """
        Fonction pour afficher les données avec les filtres de la page de recherche contrainte
    """
    ...
    if request.method == "POST":
        ...
        affichage_choix_form = request.GET.get("affichage_choix", 0)
        affichage_detail = affichage_choix_form
        ...
        if contrainte_form == 0:
            ...
            form.fields['affichage_choix'].initial = affichage_choix_form
    ...
    return render(request, 'portefeuille/contrainte.html', context={"page_obj": page_obj, "form": form,
                                                                    "type_affichage": affichage_detail})
